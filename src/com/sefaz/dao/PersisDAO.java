...
import com.sefaz.conection.Conection;
...
public class PersisDAO {
	...
	public boolean include(Usuario usuarios) throws SQLException {
		...
		try {
			...
			//Cria a Query SQL para alimentar para inserir no banco
	...
	public boolean edit(Usuario usuarios) throws SQLException {
		...
		try {
			...
			//Cria a Query SQL para atualizar o banco de dados de acordo com o id do usuário
	...
	public boolean delete(int idUsuario) throws SQLException {
		...
		try {
			...
			//Cria a Query SQL para deletar um registro de acordo com o id do usuário
	...
	//Consulta um usuário de acordo com o id 
	...
	//Metodo de login de usuario para autenticar no banco
